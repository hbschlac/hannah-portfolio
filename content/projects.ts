...
export const projects: Project[] = [
  ...
  },
  {
    ...
    oneLiner: "A private design gallery aggregating inspiration from Instagram, Amazon, Pinterest, and Houzz — paired with an AI advisor that already knows your home.",
    ...
    problem: "I bought a house and started collecting design inspiration everywhere at once — Instagram, Amazon, Pinterest, Houzz, Zillow. By the time I sat down with an interior designer, my 'inspiration' lived across six apps with no connective tissue. There was no single place that held what I actually wanted.",
    hypothesis: "A private gallery that accepts images from any source can turn scattered screenshots into a coherent brief. Add structure — categories, notes, annotations — and it becomes a shared language between you and your designer. Layer an AI advisor on top that already knows your home, and you can skip re-explaining every time you have a question.",
    built: "A Next.js gallery where images from any source get a category, a like, a note, and optional shape annotations — fully private behind a password wall.\n\nLayered on top: a persistent Claude skill that already knows the home (Spanish Revival, Oakland), the design pillars, and the room priorities. Ask it anything and it has context before you finish the question.",
    ...
    learned: "A design gallery is most valuable not as a moodboard but as a translation layer — the goal is turning screenshots into something a contractor can actually act on. The AI advisor flipped my assumption: the bottleneck isn't the model's design knowledge, it's getting your taste into a format the model can use.",
    ...
    artifacts: {
      screenshots: [
        ...
        "/projects/home-design/tile-edit.jpg",
      ...
      screenshotCaptions: [
        ...
        "Detail view: category tag, shape annotation, and note in one panel",
        "The iOS Shortcut that powers the share-sheet pipeline",
        "Selecting a Studio McGee post from Instagram to save",
        "Confirmation: saved to the Calmar gallery from Instagram",
        "Amazon product page for a fluted sideboard — one tap to save",
        "Confirmation: saved to the Calmar gallery from Amazon",
      ],
  ...
  },
  {
    ...
    built: "A structured wishlist — not a complaint list, but a product brief — written across three reflection rounds after completing multiple solo vibe-coding projects. Covers: cross-session memory, team context sharing, security transparency for non-technical builders, better handling of novel problems, and onboarding for non-engineers.",
  ...
  },
  {
    ...
    oneLiner: "A working enterprise agent-builder built in a day for my Vercel PM application — live on Vercel with AI SDK, Upstash Redis, and demo mode built in.",
  ...
  },
  {
    ...
    hypothesis: "I surveyed over 100 young Jewish adults before building anything. The finding was consistent: they wanted it to feel like CB2, not a synagogue gift shop — and they wanted entry-level pricing, something you could buy for yourself at 27, not just receive as a wedding gift.",
