...
export default function BakedByHannahPage() {
  return (
    <main
    ...
    >
      ...
      <div className="flex-grow max-w-xl mx-auto w-full px-6 pt-8 pb-10">
        ...
        <img
          ...
          style={{ width: "clamp(180px, 56vw, 240px)", height: "clamp(180px, 56vw, 240px)", objectFit: "contain" }}
        />

        {/* Headline */}
        <h1
          className="font-bold leading-tight mb-6"
          style={{ fontSize: "clamp(1.5rem, 5.5vw, 2rem)", color: "#1A1A1A" }}
        >
          hi, i&apos;m Hannah Schlacter.{" "}
        ...
        >
          <p>
            if you&apos;re eating something right now, Sam (my husband) made
            you scan this.
          </p>
          <p>
            i&apos;m looking for{" "}
          ...
          <p>
            i&apos;m a pm at Walmart ecommerce — i own the ML system that
            decides which seller offer you see when you shop.
          </p>
        </div>
